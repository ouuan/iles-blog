...
-   [【开源论文太少了！】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/misc-paper)的八岐大蛇部分
-   [【提权潜兵 · 新指导版】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/web-clash)彩蛋的光敏性癫痫警告
-   [【传统 C 语言核易危】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/binary-safekernel)的题目名、“核已畏”图片、技能五子棋
-   [【我放弃了一 key 到底】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/algo-tree)的梗是出题人选的，我改了一下缝法
-   [【千年讲堂的方形轮子 II】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/algo-oracle2)的整个题面
-   [【高级剪切几何】](https://github.com/PKU-GeekGame/geekgame-5th/blob/master/official_writeup/algo-ACG)修改了一下出题人一开始的表述
