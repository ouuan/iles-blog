...
就是 [High quality configurations - mpv - ArchWiki](https://wiki.archlinux.org/title/Mpv#High_quality_configurations)。
...
```
G               script-message cycle-commands 'apply-profile vo-gpu-next ; show-text "vo: gpu-next"' 'apply-profile vo-gpu ; show-text "vo: gpu"'
```
