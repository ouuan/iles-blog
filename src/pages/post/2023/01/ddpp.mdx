...
UPD: 终于读完第一章了。drill problem 第一题是，“Give three different definitions for the word <span class="font-latin">‘</span>bit<span class="font-latin">’</span> as used in this chapter”（
