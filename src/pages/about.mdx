...
博客正文部分使用的字体是 [思源宋体](https://github.com/adobe-fonts/source-han-serif)，引用块部分使用的是 [<span class="font-kai">霞鹜文楷</span>](https://github.com/lxgw/LxgwWenKai)，二者均以 OFL 授权。使用了 web font，可以参考 [CSS](https://github.com/ouuan/iles-blog/blob/master/src/styles/fonts.scss) 和 [字体文件](https://github.com/ouuan/iles-blog/tree/master/public/assets/fonts)。其中字体文件是我参照 Google Fonts 的 Unicode range 划分自行使用 [fonttools](https://github.com/fonttools/fonttools) 转换得到的。
...
-   单篇文章的 commits: 在文章 URL 的后面加上 `/commits.xml`/`.atom`/`.json`，例如 [《初学 Rust》的 commits](https://ouuan.moe/post/2022/08/learn-rust/commits.xml)

P.S. 可以使用 [RSSHub Radar](https://github.com/DIYgod/RSSHub-Radar) 等插件自动发现这些订阅。
